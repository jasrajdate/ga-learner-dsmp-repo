...
# X_train_temp = StandardScaler().fit_transform(X_train.iloc[:,0:size]
# X_test_temp = StandardScaler().fit_transform(X_test.iloc[:,0:size])


# #Standardized
# #Apply transform only for non-categorical data
# X_train1 = numpy.concatenate((X_train_temp,X_train[:,size:]),axis=1)

# #Concatenate non-categorical data and categorical
# X_test1 = numpy.concatenate((X_test_temp,X_val[:,size:]),axis=1)

# scaled_features_train_df = X_train1.columns

# scaled_features_test_df = X_test1.columns
